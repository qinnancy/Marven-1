  ...
  <div class="list-title">
      ...
      <div class="total-box">
        <div class="left-total">
            ...
            <div class="total-content">披露投资项目</div>
        </div>
        <div class="line-center"></div>
        <div class="right-total">
            <div class="total-num">{{detailInfor.investProjectAmount}}<span>{{detailInfor.investProjectAmountUnit}}</span></div>
            <div class="total-content">披露总投资金额</div>
        </div>
      </div>
  </div>
  <div class="list-content" v-for="(item,index) in detailInfor.projectList" :key="String(index)">
     <div class="content-header"><img src="@/assets/项目.svg" class="project-icon"/><span class="project-name">{{item.projectName}}</span></div>
     <div class="content-line">
         <div class="line-title">投资企业</div>
         <div class="line-content">{{item.investmentCompany}}</div>
     </div>
     <div class="content-line">
     ...
     <div class="content-line">
         <div class="line-title">项目产能</div>
         <div class="line-content" style="line-height:1.4rem;margin-top:0.35rem;">{{item.projectCapacity}}</div>
     </div>
      <!-- {{item}} -->
      <div class="list-bottom">
          ...
          <div class="bottom-item center-item">
              ...
              <div class="item-name"><img src="@/assets/投资金额.svg"/>投资金额</div>
          </div>
          <div class="line-center"></div>
          <div class="bottom-item center-item">
              <div class="item-value">{{item.annualOutput}}</div>
              <div class="item-name"><img src="@/assets/年产值.svg"/>年产值</div>
          </div>
          <div class="line-center"></div>
          <div class="bottom-item" style="text-align:center">
              <div class="item-value">{{item.annualTax}}</div>
              <div class="item-name"><img src="@/assets/纳税.svg"/>年纳税</div>
          </div>
      </div>
  </div>
      <div class="footer">
...
export default {
  ...
  methods:{
    getDetail(name,id){
        ...
        api
        .get(`/Industry/GetIndustryProject?primaryCategory=企业投资&secondaryCategory=${secondaryCategory}&currentId=${id}`)
        .then((res) => {
